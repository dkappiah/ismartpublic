...
const DetailsForm: React.FC = (): JSX.Element => {
      ...
      <div className="mt-5 p-10 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            type="text"
            name="companyCode"
            placeholder="Company Code/Registration Code"
          ...
          <input
            type="text"
            name="currency"
            placeholder="Currency(Trading Currency)"
          ...
          <input
            type="text"
            name="accessMask"
            placeholder="Access Mask / Level"
            value={formData.accessMask}
            onChange={handleChange}
            className="w-full p-2 border rounded"
          />
          <button
